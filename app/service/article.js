...
class HomeService extends Service {
  ...
  async filter(type) {
    ...
    switch (parseInt(type)) {
      case 0:
        article = await this.app.mysql.query(`SELECT  a.*,b.name AS categoryName from article AS a INNER JOIN category AS b ON a.categoryId = b.id WHERE status=2
         ORDER BY updateTime DESC`);
        ...
        break;
      case 1:
        article = await this.app.mysql.query(`SELECT  a.*,b.name AS categoryName from article AS a INNER JOIN category AS b ON a.categoryId = b.id 
